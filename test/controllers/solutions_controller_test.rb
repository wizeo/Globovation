...
class SolutionsControllerTest < ActionController::TestCase
  ...
  test "should create solution" do
    assert_difference('Solution.count') do
      post :create, solution: { admin_approval: @solution.admin_approval, description: @solution.description, title: @solution.title, votes: @solution.votes }
    end
  ...
  test "should update solution" do
    patch :update, id: @solution, solution: { admin_approval: @solution.admin_approval, description: @solution.description, title: @solution.title, votes: @solution.votes }
    assert_redirected_to solution_path(assigns(:solution))
  end
